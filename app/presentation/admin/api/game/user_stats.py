...
from app.presentation.admin.common import Request
from .schemes import UserStatsResponseSchema
from app.core.game.exceptions import (
    PlayerNotFoundException
)
from app.presentation.admin.utils import json_response
...
async def user_stats(request: Request) -> Response:
    ...
    handler = get_user_stats_on_games_by_tg_id_handler_build(
        session
    )
    try:
