...
Revision ID: d2f33faed566
Revises: 
Create Date: 2023-03-11 16:33:08.213505
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PLAYING', 'BET', 'MOTION', 'SKIP', 'LOSE', name='playerstatus'), nullable=False),
