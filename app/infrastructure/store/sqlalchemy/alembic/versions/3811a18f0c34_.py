...
Revision ID: 3811a18f0c34
Revises: 
Create Date: 2023-03-13 11:24:34.587315
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PLAYING', 'BET', 'MOTION', 'SKIP', 'LOSE', 'WIN', 'DRAW', name='playerstatus'), nullable=False),
